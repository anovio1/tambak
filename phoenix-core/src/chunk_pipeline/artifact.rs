...
impl CompressedChunk {
    ...
    /// This is the authoritative "writer" for the Phoenix chunk format. It guarantees
    ...
    pub fn peek_info(bytes: &[u8]) -> Result<HeaderInfo, PhoenixError> {
...
mod tests {
    ...
    fn test_malformed_inputs_are_rejected() {
        ...
        assert!(matches!(res, Err(PhoenixError::FrameFormatError(_))));
    }
