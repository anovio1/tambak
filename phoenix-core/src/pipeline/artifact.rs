...
impl CompressedChunk {
    ...
    pub fn from_bytes(bytes: &[u8]) -> Result<Self, PhoenixError> {
        ...
        cursor
            ...
            .map_err(|_| PhoenixError::FrameFormatError("Truncated magic number".into()))?;
        if &magic_buf != b"CHNK" {
        ...
        cursor.read_exact(&mut u32_buf).unwrap();
        ...
        // The corrected closure pattern for reading.
            ...
            let len = match len_bytes {
                2 => {
                    ...
                    c.read_exact(&mut buf)
                        .map_err(|_| PhoenixError::FrameFormatError("Read error".into()))?;
        ...
        header_cursor.read_exact(&mut u16_buf).unwrap();
        ...
        for _ in 0..stream_count {
            ...
            header_cursor.read_exact(&mut u64_buf).unwrap();
        ...
        for (id, len) in stream_metadata {
            ...
            cursor
                ...
                .map_err(|_| PhoenixError::FrameFormatError("Truncated stream data".into()))?;
