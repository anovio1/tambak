...
pub fn find_stride_by_autocorrelation(
    ...
    let data_f64 = match dtype {
        TambakDataType::Int8 => to_f64_vec!(i8, bytes),
        TambakDataType::Int16 => to_f64_vec!(i16, bytes),
        TambakDataType::Int32 => to_f64_vec!(i32, bytes),
        TambakDataType::Int64 => to_f64_vec!(i64, bytes),
        TambakDataType::UInt8 => to_f64_vec!(u8, bytes),
        TambakDataType::UInt16 => to_f64_vec!(u16, bytes),
        TambakDataType::UInt32 => to_f64_vec!(u32, bytes),
        TambakDataType::UInt64 => to_f64_vec!(u64, bytes),
        TambakDataType::Float32 => to_f64_vec!(f32, bytes),
        TambakDataType::Float64 => to_f64_vec!(f64, bytes),
        TambakDataType::Boolean => return Ok(1), // Autocorrelation not meaningful for booleans
    };
...
// pub fn find_stride_by_autocorrelation(bytes: &[u8], type_str: &str) -> Result<usize, tambakError> {
